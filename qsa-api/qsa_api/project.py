                ...
                if (
                    ...
                    if (
                        ...
                        if renderer.red_max is not None:
                            self.debug.log("renderer.red_max" + str(renderer.red_max))
                        ...
                        if renderer.green_max is not None:
                            self.debug.log("renderer.green_max" + str(renderer.green_max))
                        ...
                        if renderer.blue_max is not None:
                            self.debug.log("renderer.blue_max" + str(renderer.blue_max))
